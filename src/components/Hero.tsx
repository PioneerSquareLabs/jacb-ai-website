...
const HeroSection = () => {
  const handleWaitlistClick = () => {
    // TODO: Implement waitlist sign-up logic
    console.log('Waitlist button clicked');
  };

  return (
    <div className="flex flex-col md:flex-row items-center md:items-start bg-white">
      <div className="flex-1 flex flex-col justify-center p-8 space-y-6">
        ...
        <button
          className="bg-blue-500 hover:bg-blue-600 text-white rounded-md shadow-lg shadow-purple-500/50 px-6 py-2 flex items-center transition duration-150 ease-in-out"
