  ...
  return (
    <div className="relative bg-gradient-to-r from-purple-600 to-blue-500 min-h-screen flex flex-col justify-center items-center text-white p-4">
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full max-w-2xl px-6 py-12 bg-white rounded-lg shadow-xl text-center">
        ...
        <div className="flex justify-center items-center">
          ...
          <input
            ...
            className="mt-1 block w-full px-4 py-2 text-lg bg-gray-100 border-2 border-gray-300 rounded-md placeholder-gray-500 focus:ring-blue-500 focus:border-blue-500 ml-2"
            value={email}
            onChange={handleEmailChange}
          />
        </div>
        <button
          className="mt-4 px-6 py-2 bg-purple-700 hover:bg-purple-800 rounded-md shadow-lg text-white font-semibold"
      ...
      <div className="mt-12 max-w-xl text-center">
        <img src="video.png" alt="Demo video" className="mx-auto mb-4" />
        <div className="mb-4">
